...
// - 50-100: Backgrounds (White/Off-White)
// - 200-300: Borders
// - 500-600: Secondary Text (DARK Gray, not light gray)
// - 700-900: Primary Text (Black)

// Dark Palette (Dark Mode):
// - 50-200: Primary Text (White)
// - 300-400: Secondary Text (Light Gray)
// - 800-950: Backgrounds (Deep Black)
