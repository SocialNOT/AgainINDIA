...
export const translateText = async (text: string, targetLang: string = "Hindi"): Promise<string> => {
  if (!process.env.API_KEY) return "Translation unavailable (API Key missing).";
